...
@implementation ReactNativeAdalUtils
...
{
  NSMutableDictionary *dict = (obj.status == AD_SUCCEEDED) ? [ReactNativeAdalUtils ADTokenCacheStoreItemToDictionary:obj.tokenCacheItem] : [ReactNativeAdalUtils ADAuthenticationErrorToDictionary:obj.error];
...
+ (NSMutableDictionary *)ADTokenCacheStoreItemToDictionary:(ADTokenCacheItem *)obj
{
  ...
  {
    [dict setObject:[ReactNativeAdalUtils ADUserInformationToDictionary:obj.userInformation] forKey:@"userInfo"];
